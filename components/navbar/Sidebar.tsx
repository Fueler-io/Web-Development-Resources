...
const Sidebar = (props: ToggleProps) => {
  ...
  return (
    <div
      ...
      } h-screen px-4 py-4 bg-gradient-to-tr from-black-brand-08 to-black shadow-inner w-full lg:w-60 xl:w-64 2xl:w-80 lg:px-6 xl:px-8 lg:py-6 lg:flex overflow-scroll border-r border-black-brand-06`}
    >
